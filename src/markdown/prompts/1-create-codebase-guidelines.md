...
This document provides guidelines for developers working on the Admin User Management System, a Next.js application that allows administrators to view, create, edit, and delete users.
