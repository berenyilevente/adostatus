...
export const FeaturesHeader = (): ReactElement => {
  return (
    <div className="text-center">
      ...
      <p className="mt-2 text-3xl font-semibold">Everything You Need in One Platform</p>
      <p className="mt-3 inline-block max-w-md text-base-content/80">
        ...
        {config.app.name} handles it all with a flexible platform designed for multi-business
        owners.
      </p>
    </div>
  );
