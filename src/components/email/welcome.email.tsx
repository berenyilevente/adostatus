    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          ...
          <Hr style={hr} />
          <Text style={paragraph}>Thanks for joining the {config.app.name} waitlist!</Text>
          <Text style={paragraph}>You have secured your discount! 🤑</Text>
          <Text style={paragraph}>We will notify you about the launch date, can&apos;t wait!</Text>
          <Hr style={hr} />
