  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'flex flex-wrap gap-1 p-1 py-2 ring-1 ring-muted border rounded-lg bg-background',
          {
...
>(({ className, ...props }, _ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        'ml-2 bg-transparent focus-visible:outline-none border-none text-sm !outline-none placeholder:text-muted-foreground flex-1',
        className,
